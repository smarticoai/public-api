...
export class WSAPI {
	 ...
	 * ```
	 */
	// TODOYY: validation sourced 40013/40014/105 from r-server Java handlers via hive — confirm against AchievementOptinRequestHandler.java before next SDK release.
	// TODOYY: example uses showError/showUnlockTasks as placeholders — replace with real UI handlers or note them as user-supplied in the doc body.
