...
export class WSAPIStore extends WSAPIBonuses {
	 ...
	 *   {@link getStoreCategories} — an item can appear in multiple categories;
	 ...
	 *   rows returned from {@link getStorePurchasedItems} (purchase history),
	 ...
	 * method (NOT by {@link getStoreItems}):
