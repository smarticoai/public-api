...
The type of the prize — see [SAWPrizeType](../enumerations/SAWPrizeType.md)
...
Period basis for the prize availability restriction — see [AttemptPeriodType](../enumerations/AttemptPeriodType.md)
