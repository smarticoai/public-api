# _smartico.on — events & callbacks

> _smartico.on — events & callbacks.
> Search terms: on, off, callbacks, events, subscribe, subscribeUpdate, onWin, onReady, props_change, identify, EXTERNAL_CALLBACK, lifecycle, _smartico.on
