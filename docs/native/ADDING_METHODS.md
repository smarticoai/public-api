...
- ../interfaces/ contains typedoc-style interface documentation files
...
3. For complex types — link to ../interfaces/*.md files
4. If raw interface MD file doesn't exist in ../interfaces/ — create it following typedoc style like existing files there:
